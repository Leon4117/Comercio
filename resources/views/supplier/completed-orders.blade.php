                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($completedOrders as $order)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $order->event->event_date->format('d/m/Y') }}
                                        </div>
                                        <div class="text-xs text-gray-500">{{ $order->event->event_date->format('l, F j') }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <!-- Botón de chat -->
                                        @if ($order->chat_link)
                                            <a href="{{ $order->chat_link }}" target="_blank"
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    ${{ number_format($totalEarnings / $completedOrders->total(), 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    {{ $completedOrders->where('urgent', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    ${{ number_format($completedOrders->where('updated_at', '>=', now()->startOfMonth())->sum('final_price'), 2) }}
                                </dd>
                            </dl>
                        </div>
                    </div>
