...
<div class="p-6">
    ...
    <form action="{{ route('supplier.services.update', $service) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
                ...
                <div>
                    ...
                    <select id="category" 
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ old('category', $service->supplier->category_id) == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2">
                            ...
                            <div id="urgent_price_section" class="mt-4 {{ old('urgent_available', $service->urgent_available) ? '' : 'hidden' }}">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-2">Sube nuevas imágenes para reemplazar todo el portafolio actual.</p>
            </div>
            @endif
            ...
            <div>
                <label for="portfolio_images" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $service->portfolio_images ? 'Nuevo Portafolio (Opcional)' : 'Subir Fotos de Referencia' }} (Máx. 5)
                </label>
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition-colors">
                    <div class="space-y-1 text-center">
