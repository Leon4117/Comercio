<x-guest-layout>
    ...
    <form method="POST" action="{{ route('supplier.complete-registration') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <div class="relative">
                ...
                <select id="price_range"
                    ...
                    <option value="$500 - $2,000" {{ old('price_range') == '$500 - $2,000' ? 'selected' : '' }}>$500 - $2,000</option>
                    <option value="$2,000 - $5,000" {{ old('price_range') == '$2,000 - $5,000' ? 'selected' : '' }}>$2,000 - $5,000</option>
                    <option value="$5,000 - $10,000" {{ old('price_range') == '$5,000 - $10,000' ? 'selected' : '' }}>$5,000 - $10,000</option>
                    <option value="$10,000 - $25,000" {{ old('price_range') == '$10,000 - $25,000' ? 'selected' : '' }}>$10,000 - $25,000</option>
        ...
        <div>
            ...
            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition-colors">
                <div class="space-y-1 text-center">
                    <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                        <path d="M8 14a6 6 0 016-6h20a6 6 0 016 6v20a6 6 0 01-6 6H14a6 6 0 01-6-6V14z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M24 18a4 4 0 100 8 4 4 0 000-8z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M16 32l4-4 8 8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <div class="flex text-sm text-gray-600">
                        <label for="identification_photo" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                            <span>Subir identificación</span>
                            <input id="identification_photo" name="identification_photo" type="file" class="sr-only" required accept=".jpg,.jpeg,.png">
                        </label>
                        <p class="pl-1">o arrastra y suelta</p>
                    </div>
    ...
    <div class="text-center pt-4 border-t border-gray-200">
        <p class="text-sm text-gray-600">
            ...
            <form action="{{ route('logout') }}" method="POST" novalidate>
                @csrf
                <button type="submit"
                        class="font-medium text-blue-600 hover:text-blue-800" formnovalidate>
                    Cerrar sesión
                </button>
            </form>
        </p>
