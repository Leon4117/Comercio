        ...
        <div class="max-w-full w-full space-y-8 px-4">
            ...
            <div class="grid md:grid-cols-2 gap-16 mt-16 max-w-7xl mx-auto">
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-2xl p-16 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        <!-- Icon -->
                        <div class="w-24 h-24 bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl flex items-center justify-center mb-8 mx-auto">
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-2xl p-16 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        <!-- Icon -->
                        <div class="w-24 h-24 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center mb-8 mx-auto">
                            <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
