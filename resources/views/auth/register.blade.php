<x-guest-layout>
    ...
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold text-gray-900 mb-2">Únete a Festivando</h2>
        <p class="text-gray-600">
            Crea tu cuenta de {{ $userType === 'client' ? 'cliente' : 'proveedor' }}
        </p>
        
        <!-- User Type Indicator -->
        <div class="mt-4 inline-flex items-center px-4 py-2 rounded-full {{ $userType === 'client' ? 'bg-pink-100 text-pink-800' : 'bg-blue-100 text-blue-800' }}">
            ...
            Registro como {{ $userType === 'client' ? 'Cliente' : 'Proveedor' }}
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div class="text-center pt-4">
            <p class="text-sm text-gray-600">
                ¿Quieres registrarte como {{ $userType === 'client' ? 'proveedor' : 'cliente' }}? 
