                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg text-sm font-medium transition">
                            Dashboard
                        </a>
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register.select-type') }}"
                                class="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg text-sm font-medium transition">
                                Registrarse
                            </a>
                        @endif
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p class="text-xl text-gray-600 mb-8 leading-relaxed">
                        Encuentra proveedores expertos y haz tu evento perfecto con la mejor plataforma P2P para
                        fiestas, bodas y más.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('register') }}"
                            class="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
                            Buscar proveedores
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center group">
                    <div
                        class="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors">
                        <svg class="w-10 h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0A2.704 2.704 0 004.5 16c-.523 0-1.046-.151-1.5-.454M6.75 6.75L12 3l5.25 3.75M12 21l-8.25-8.25L12 3l8.25 9.75L12 21z">
                            </path>
                        </svg>
                    </div>
                ...
                <div class="text-center group">
                    <div
                        class="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors">
                ...
                <div class="text-center group">
                    <div
                        class="w-20 h-20 bg-pink-100 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors">
                        <svg class="w-10 h-10 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1a3 3 0 000-6h-1m4 6V4a3 3 0 013-3m-3 14a3 3 0 01-3-3m-3 3a3 3 0 01-3-3m3-3h3m-3 0h-3">
                            </path>
                        </svg>
                    </div>
                ...
                <div class="text-center group">
                    <div
                        class="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors">
        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div class="space-y-6">
                ...
                <div class="border border-gray-200 rounded-lg">
                    ...
                    <div class="px-6 pb-4">
                        <p class="text-gray-600">Puedes buscar por categoría (bodas, XV años, fiestas) o usar nuestro
                            buscador. Todos nuestros proveedores están verificados y cuentan con reseñas de clientes
                            anteriores.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg">
                    ...
                    <div class="px-6 pb-4">
                        <p class="text-gray-600">Sí, buscar y contactar proveedores es completamente gratis. Solo pagas
                            directamente al proveedor que elijas para tu evento.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg">
                    ...
                    <div class="px-6 pb-4">
                        <p class="text-gray-600">Una vez que encuentres un proveedor que te guste, puedes enviarle un
                            mensaje directo a través de nuestra plataforma o llamarlo directamente si tiene su número
                            disponible.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg">
                    ...
                    <div class="px-6 pb-4">
                        <p class="text-gray-600">¡Por supuesto! Si ofreces servicios para eventos, puedes registrarte
                            como proveedor y empezar a recibir solicitudes de clientes potenciales.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-8">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">ld.aghdz@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">+52 444 490 4290</p>
