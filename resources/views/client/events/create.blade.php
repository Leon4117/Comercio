            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <form action="{{ route('client.events.store') }}" method="POST" id="eventForm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="location" name="location"
                                    value="{{ old('location', 'San Luis Potosí') }}" required
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 transition duration-200"
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Selecciona los tipos de servicio que deseas cotizar o buscar
                            para este evento:</p>

                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            @foreach ($categories as $category)
                                <label
                                    class="flex items-center p-4 border border-gray-200 rounded-lg hover:border-secondary-300 hover:bg-secondary-50 cursor-pointer transition-colors">
